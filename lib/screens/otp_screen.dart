// OTP Screen - Verifikasi kode OTP
// ✅ Navigasi: setelah verify → pop ke '/' → AuthWrapper handle redirect
...
class _OTPScreenState extends State<OTPScreen> {
  ...
  void _verifyOTP() async {
    ...
    if (result['success']) {
      ...
      // ✅ Pop semua screen sampai root
      // AuthWrapper akan otomatis detect auth state dan tampilkan Dashboard
